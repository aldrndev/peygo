...
export default function ResendConfirmationPage() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<ResendSchema>({
    resolver: zodResolver(resendSchema),
  });

  const onSubmit = async (data: ResendSchema) => {
    setIsPending(true);
    setServerError(null);
      ...
      <div className="space-y-8">
        <div className="text-center lg:text-left">
          ...
          <p className="text-muted-foreground text-lg">
            Jika email terdaftar, Anda akan menerima link konfirmasi. Silakan cek inbox.
          </p>
        </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center lg:text-left">
        ...
        <p className="text-muted-foreground text-lg">
          Masukkan email Anda untuk menerima link konfirmasi baru.
        </p>
      </div>
        ...
        <CardContent className="p-8 md:p-10">
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
            ...
            <Button 
              ...
              isLoading={isPending}
            >
              {isPending ? "Memproses..." : "Kirim Email Konfirmasi"}
            </Button>
          </form>
        </CardContent>
      </Card>
